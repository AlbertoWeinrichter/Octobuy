...
export default {
  ...
  async fetch() {
    ...
    this.user = {
      ...
      username: 'ihavecoke',
      name: 'mixbo',
      summary: 'Web developer in Longbridge',
      twitter_username: null,
      github_username: 'ihavecoke',
      website_url: 'https://longbridge.global/en',
      location: 'China Chengdu',
      joined_at: 'Feb 13, 2018',
      profile_image:
        'https://res.cloudinary.com/practicaldev/image/fetch/s--mgtpgI4e--/c_fill,f_auto,fl_progressive,h_320,q_auto,w_320/https://dev-to-uploads.s3.amazonaws.com/uploads/user/profile_image/57521/b7dc9700-cb91-4148-a6a4-d1b4494db8e2.png'
    }
  },
  fetchOnServer: false,
  data() {
